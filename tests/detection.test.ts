...
// Pipeline test fixture mirrors the configured POC inventory so quiet vs noisy
// branches of the cheap filter behave as in production until DB-backed inventory
// arrives for live runs.
const testInventory = loadMonitoredVendors();
    ...
    const maxSignalDecision = decideCheapFilter(
      {
        ...
        rssSummary:
          'CISA added the known exploited vulnerability after emergency patches for Microsoft SharePoint Server.',
